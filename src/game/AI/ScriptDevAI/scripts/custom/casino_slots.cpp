...
bool GossipSelect_slots(Player *player, Creature *creature, uint32 sender, uint32 action)
{
    ...
    case 21:
        ...
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_mage:30|t 3x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_rogue:30|t 3x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_hunter:30|t 3x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_paladin:30|t 3x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_shaman:30|t 10x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_warrior:30|t 10x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_warlock:30|t 10x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_priest:30|t 10x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 1x |TInterface\\icons\\classicon_druid:30|t 1.5x", GOSSIP_SENDER_MAIN, 4);
        player->ADD_GOSSIP_ITEM(6, " 3x |TInterface\\icons\\classicon_druid:30|t 20x", GOSSIP_SENDER_MAIN, 4);
    ...
    if (action < 4)
    {
        ...
        if (player->GetMoney() > bet_amount_slots)
        {
            ...
            player->ADD_GOSSIP_ITEM(5, " Change bet", GOSSIP_SENDER_MAIN, 4);
        }
